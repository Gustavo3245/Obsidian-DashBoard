...
- quando a view está na área central, a hierarquia do `WorkspaceLeaf` ativa um cabeçalho com título e subtítulo seguido por cinco linhas de cards em uma malha de 24 colunas: duas fileiras de quatro resumos; gráfico diário, insights de tags, um card vazio para futuros insights do Vault e atividade recente; streak; e três cards vazios para os futuros rankings. O dashboard completo e seu grid são centralizados, possuem moldura arredondada e são limitados a 1000px de largura, impedindo novas expansões visuais acima desse limite. O card lateral de tempo estimado é desmembrado visualmente nos cards de leitura e fala, enquanto `File types` fica oculto nesse modo. Mover a aba entre a área central e os painéis recalcula esse modo.
